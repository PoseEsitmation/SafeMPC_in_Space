...
custom_envs = {
            ...
            "PusherMovingGoal-v0":
                dict(path='hypercrl.envs.mujoco.modified_arm:PusherMovingGoalEnv',
                     max_episode_steps=100,
                     reward_threshold=0.0,
                     kwargs= dict()),
            # Pusher modifications
            "PusherLeftSide-v0":
                dict(path='hypercrl.envs.mujoco.modified_arm:PusherLeftSide',
                     max_episode_steps=100,
                     reward_threshold=0.0,
                     kwargs= dict()),
            "PusherFullRange-v0":
                dict(path='hypercrl.envs.mujoco.modified_arm:PusherFullRange',
                     max_episode_steps=100,
                     reward_threshold=0.0,
                     kwargs= dict()),
            # Striker
            "StrikerMovingStart-v0":
                dict(path='hypercrl.envs.mujoco.modified_arm:StrikerMovingStartStateEnv',
                     max_episode_steps=100,
                     reward_threshold=0.0,
                     kwargs= dict()),
            ...
            "AntGravityMars-v0" :
                dict(path='hypercrl.envs.mujoco.modified_ant:AntGravityEnv',
            ...
            "HopperGravityHalf-v0" :
                dict(path='hypercrl.envs.mujoco.modified_hopper:HopperGravityEnv',
                     max_episode_steps=1000,
                     reward_threshold=3800.0,
                     kwargs= dict(gravity=-4.905)),
            ...
            "Walker2dGravityHalf-v0" :
                dict(path='hypercrl.envs.mujoco.modified_walker2d:Walker2dGravityEnv',
                     max_episode_steps=1000,
                     kwargs= dict(gravity=-4.905)),
            ...
            "HumanoidGravityHalf-v0" :
                dict(path='hypercrl.envs.mujoco.modified_humanoid:HumanoidGravityEnv',
                     max_episode_steps=1000,
                     kwargs= dict(gravity=-4.905)),
            ...
            "AntMaze-v0" :
                dict(path='hypercrl.envs.mujoco.modified_ant:AntMaze',
                     max_episode_steps=1000,
                     reward_threshold=3800.0,
                     kwargs= dict()),
            "HopperStairs-v0" :
                dict(path='hypercrl.envs.mujoco.modified_hopper:HopperStairs',
                     max_episode_steps=1000,
                     reward_threshold=3800.0,
                     kwargs= dict()),
            "HopperSimpleWall-v0" :
                dict(path='hypercrl.envs.mujoco.modified_hopper:HopperSimpleWallEnv',
                     max_episode_steps=1000,
                     reward_threshold=3800.0,
                     kwargs= dict()),

            "HopperWithSensor-v0" :
                dict(path='hypercrl.envs.mujoco.modified_hopper:HopperWithSensorEnv',
                     max_episode_steps=1000,
                     reward_threshold=3800.0,
                     kwargs= dict(model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/hopper.xml")),
            "Walker2dWall-v0" :
                dict(path='hypercrl.envs.mujoco.modified_walker2d:Walker2dWallEnv',
                     max_episode_steps=1000,
                     kwargs= dict()),
            "Walker2dWithSensor-v0" :
                dict(path='hypercrl.envs.mujoco.modified_walker2d:Walker2dWithSensorEnv',
                     max_episode_steps=1000,
            ...
            "HumanoidWall-v0" :
                dict(path='hypercrl.envs.mujoco.modified_humanoid:HumanoidWallEnv',
                     max_episode_steps=1000,
                     kwargs= dict()),
            "HumanoidWithSensor-v0" :
                dict(path='hypercrl.envs.mujoco.modified_humanoid:HumanoidWithSensorEnv',
                     max_episode_steps=1000,
                     kwargs= dict(model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/humanoid.xml")),
            "HumanoidStandupWithSensor-v0" :
                dict(path='hypercrl.envs.mujoco.modified_humanoid:HumanoidStandupWithSensorEnv',
                     max_episode_steps=1000,
            ...
            "HumanoidStandupAndRunWall-v0" :
                dict(path='hypercrl.envs.mujoco.modified_humanoid:HumanoidStandupAndRunWallEnv',
                     max_episode_steps=1000,
                     kwargs= dict()),
            "HumanoidStandupAndRunWithSensor-v0" :
                dict(path='hypercrl.envs.mujoco.modified_humanoid:HumanoidStandupAndRunEnvWithSensor',
                     max_episode_steps=1000,
                     kwargs= dict(model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/humanoidstandup.xml")),
            "HumanoidStandupAndRun-v0" :
                dict(path='hypercrl.envs.mujoco.modified_humanoid:HumanoidStandupAndRunEnv',
                     max_episode_steps=1000,
                     kwargs= dict()),

            # Modified body parts - Hopper
            "HopperBigTorso-v0" :
                dict(path='hypercrl.envs.mujoco.modified_hopper:HopperModifiedBodyPartSizeEnv',
                     max_episode_steps=1000,
                     reward_threshold=3800.0,
            ...
            "Walker2dBigTorso-v0" :
                dict(path='hypercrl.envs.mujoco.modified_walker2d:Walker2dModifiedBodyPartSizeEnv',
                     max_episode_steps=1000,
                     kwargs= dict(body_parts=["torso_geom"], size_scale=1.25)),
            "Walker2dBigThigh-v0" :
                dict(path='hypercrl.envs.mujoco.modified_walker2d:Walker2dModifiedBodyPartSizeEnv',
            ...
            "HumanoidBigTorso-v0" :
                dict(path='hypercrl.envs.mujoco.modified_humanoid:HumanoidModifiedBodyPartSizeEnv',
                     max_episode_steps=1000,
            ...
            "InvertedPendulumSmallPole-v0" :
                dict(path='hypercrl.envs.mujoco.modified_invertedpendulum:InvertedPendulumModifiedLengthEnv',
                     max_episode_steps=1000,
            ...
            # Modified 
            "ReacherLong1-v0" :
                dict(path='hypercrl.envs.mujoco.modified_reacher:ReacherLengthEnv',
