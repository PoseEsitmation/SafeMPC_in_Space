...
def make_space_cbf_components(
    ...
    gamma default 0.5 — KEEP IN SYNC with SpaceAttitudeCBF in
    envs/space_cbf_clf.py: the training loss must penalise the same condition
    the runtime QP filter enforces. Numeric parity between the two is checked
    by tests/test_cbf_clf_parity.py.
